    ...
    >
      <div className="mx-auto max-w-[1440px] grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 px-6 sm:px-10 lg:px-16 pt-24 lg:pt-32 pb-16 lg:pb-20 items-center">
        ...
        <div className="order-2 lg:order-1">
          ...
          {/* Headline */}
          <h2 className="font-rider text-tees-black text-5xl sm:text-6xl lg:text-7xl leading-[0.95] tracking-tight mb-10">
            Nació en la ruta.
          </h2>

          {/* Cuerpo narrativo */}
          <div className="space-y-6 font-almaq text-tees-black/80 text-lg sm:text-xl leading-relaxed max-w-xl">
            <p>
            ...
            <p className="font-cormorant italic text-tees-black text-2xl sm:text-3xl pt-4">
