    ...
    >
      <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 items-stretch">
          ...
          {/* Texto */}
          <div className="flex flex-col justify-center bg-white/[0.02] border border-brass/10 px-8 py-12 md:px-12 md:py-14">
            ...
            <blockquote className="font-cormorant italic text-moto-bone text-2xl md:text-3xl leading-snug mb-8">
              ...
              resolver todos sus problemas, nosotros tenemos una:{' '}
            ...
            {/* Respaldo */}
            <p className="font-almaq text-moto-bone/55 text-sm leading-relaxed mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {['Calidad', 'Desempeño', 'Comodidad', 'Estética'].map((pilar) => (
                <span
                  key={pilar}
                  className="border border-brass/30 text-brass font-almaq text-[10px] tracking-[0.15em] uppercase px-3 py-1.5"
                >
                  {pilar}
                </span>
              ))}
