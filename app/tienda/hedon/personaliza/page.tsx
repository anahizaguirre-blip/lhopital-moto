/**
 * Página de accesorios y personalización Hedon
 * URL: /tienda/hedon/personaliza
 *
 * Server Component — carga todos los accesorios Hedon desde Supabase.
 */
...
export default async function PersonalizaPage() {
  ...
  if (error) {
    console.error('Error cargando accesorios Hedon:', error);
  }
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-[#F4F1EC]">
      ...
      {/* Grid de accesorios con tabs */}
      <PersonalizaGrid products={productList} />

      {/* Footer mínimo — idéntico a /tienda/hedon */}
